...
Parser.prototype.parse = function(sourceFiles, encoding) {
    ...
    e.parsedfiles = parsedFiles;
    e.doclets = this._resultBuffer;
    this.emit('parseComplete', e);
    //var fs = require("jsdoc/fs");
    fs.writeFileSync(sourceFiles[0] + ".parsedump.json", JSON.stringify(this._resultBuffer, null, 4), 'utf8');
