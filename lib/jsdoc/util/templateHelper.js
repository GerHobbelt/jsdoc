...
// var containers = ['class', 'module', 'external', 'namespace', 'mixin', 'interface', 'service', 'component', 'delegate', 'reducer', 'route', 'util'];
 ...
 */
var linkto = exports.linkto = function(longname, linkText, cssClass, fragmentId, options) {
 ...
 * options.
 */
var toTutorial = exports.toTutorial = function(tutorial, content, missingOpts, options) {
    if (!tutorial) {
...
exports.resolveLinks = function(str, options) {
    options = options || {};
 ...
 */
exports.getAncestorLinks = function(data, doclet, cssClass, options) {
    ...
    ancestors.forEach(function(ancestor) {
        ...
        var link = linkto(ancestor.longname, linkText, cssClass, null, options);
        links.push(link);
    });
 ...
 */
exports.prune = function(data, options) {
    options = options || {};
...
exports.createLink = function(doclet) {
    ...
    var match;
    var isContainer = containerHasKind(doclet.kind);
