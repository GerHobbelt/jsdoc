...
This is a fork of the [jsdoc](https://github.com/jsdoc/jsdoc) project. It has a couple of things added, namely support for parsing html files. It's used by [jsdoc-parse](https://github.com/jsdoc2md/jsdoc-parse).
